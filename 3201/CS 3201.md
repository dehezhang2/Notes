...
* Web overview
  ...
  * at most one object sent over a TCP connection
    ...
    vdownloading multiple objects required multiple connections

    §If we do not consider the transmission time, it takes two round trip time (RTT) to get each object
