...
* We have leart 4 classifiers in depth: KNN, Naive Bayes, LDA and Logistic Regression
...
* Primal Form, **Hard-Margin** of SVM
  $$
  max_{\textbf w,b}({1 \over{||\textbf w||_2}})<=>min_{\textbf w,b}\ {1\over 2}||\textbf w||^2_2 \\
...
* Primal From, Soft-Margin
  ...
  * Hard margin is not enough:
    ...
    * when the data is not linear-discriminatable
