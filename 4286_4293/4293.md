...
* Midterm questions
  ...
  * present certain protocols / design digrams, tell anything wrong/secure, and reason

  * submit kind of formulas, equations
...
* **Buffer Overflows**:
  ...
  * Knowledge needed to lauch:
    ...
    * Attacker needs to know which CPU and OS used on the target machine
      ...
      * Dtails vary slightly between CPUs and OSs
...
* Unsafe libc functions
  ...
  * Windows C run time (CRT):`strcpy_s (*dest, DestSize CS4293 Topics on Cybersecurity , *src)`: ensures proper termination
