...
* Four sources of delay
  ...
  - Queueing : time waiting at output for transmission and depends on congestion level of router  (not negligible)
    ...
    - Because queuing delay can vary from packet to packtet, we use statical measures such as average queuing delay, variance of queuing delay, and the probability that the queuing delay exceeds some specified value
